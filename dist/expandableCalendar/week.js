...
const Week = React.memo((props) => {
    ...
    return (React.createElement(View, { style: style.current.container, testID: `${testID}.week_${current}` },
        React.createElement(View, { style: [style.current.week, numberOfDays > 1 ? partialWeekStyle : undefined, propsStyle] }, renderWeek())));
}, arePropsEqual);
export default Week;
