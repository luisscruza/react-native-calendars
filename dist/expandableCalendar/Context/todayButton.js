...
const TodayButton = (props, ref) => {
    ...
    return (React.createElement(Animated.View, { style: [style.current.todayButtonContainer, { transform: [{ translateY: buttonY.current }] }] },
        React.createElement(TouchableOpacity, { style: [style.current.todayButton, propsStyle], onPress: onPress, disabled: disabled },
            React.createElement(Animated.Image, { style: [style.current.todayButtonImage, { opacity: opacity.current }], source: buttonIcon }),
            React.createElement(Animated.Text, { allowFontScaling: false, style: [style.current.todayButtonText, { opacity: opacity.current }] }, today.current))));
};
