...
const CalendarProvider = (props) => {
    ...
    const _setDate = useCallback((date, updateSource) => {
        ...
        onDateChanged === null || onDateChanged === void 0 ? void 0 : onDateChanged(date, _updateSource);
        if (!sameMonth(new XDate(date), new XDate(prevDate.current))) {
            onMonthChange === null || onMonthChange === void 0 ? void 0 : onMonthChange(xdateToData(new XDate(date)), _updateSource);
        }
    ...
    const renderTodayButton = () => {
        return (React.createElement(TodayButton, { ref: todayButton, disabledOpacity: disabledOpacity, margin: todayBottomMargin, style: todayButtonStyle, theme: theme }));
    };
    return (React.createElement(CalendarContext.Provider, { value: contextValue },
        React.createElement(View, { style: wrapperStyle, key: numberOfDays }, children),
