...
const AgendaList = forwardRef((props, ref) => {
    ...
    const _renderSectionHeader = useCallback((info) => {
        ...
        return React.createElement(AgendaSectionHeader, { title: headerTitle, style: headerTextStyle, onLayout: onHeaderLayout });
    }, [headerTextStyle]);
    ...
    if (props.infiniteListProps) {
        return React.createElement(InfiniteAgendaList, Object.assign({}, props));
    }
    return (React.createElement(SectionList, Object.assign({ stickySectionHeadersEnabled: true }, props, { 
        // @ts-expect-error
