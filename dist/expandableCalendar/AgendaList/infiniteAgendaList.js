...
const InfiniteAgendaList = (_a) => {
    ...
    const _renderSectionHeader = useCallback((info) => {
        ...
        return React.createElement(AgendaSectionHeader, { title: headerTitle, style: headerTextStyle });
    }, [headerTextStyle]);
