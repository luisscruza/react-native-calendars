...
const CalendarList = (props) => {
    ...
    const renderStaticHeader = () => {
        if (shouldRenderStaticHeader) {
            return (React.createElement(CalendarHeader, Object.assign({}, headerProps, { month: new XDate(currentMonth), onPressArrowRight: scrollToNextMonth, onPressArrowLeft: scrollToPreviousMonth, style: staticHeaderStyle, accessibilityElementsHidden // iOS
                : true, importantForAccessibility: 'no-hide-descendants', testID: 'static-header' })));
        }
    };
    /** Data */
