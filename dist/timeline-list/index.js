...
const TimelineList = (props) => {
    ...
    const renderPage = useCallback((_type, item, index) => {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(Timeline, Object.assign({}, _timelineProps))));
    }, [events, timelineOffset, showNowIndicator, numberOfDays]);
    return (React.createElement(InfiniteList, { isHorizontal: true, ref: listRef, data: pages, renderItem: renderPage, onPageChange: onPageChange, onReachNearEdge: onReachNearEdge, onReachNearEdgeThreshold: NEAR_EDGE_THRESHOLD, onScroll: onScroll, extendedState: { todayEvents: events[date], pages }, initialOffset: initialOffset, scrollViewProps: {
            onMomentumScrollEnd
        } }));
};
