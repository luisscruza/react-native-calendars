...
class ReservationList extends Component {
    constructor(props) {
        ...
        this.renderRow = ({ item, index }) => {
            ...
            return (React.createElement(View, { onLayout: this.onRowLayoutChange.bind(this, index) },
                React.createElement(Reservation, Object.assign({}, reservationProps, { item: item.reservation, date: item.date }))));
        };
        this.keyExtractor = (item, index) => {
            var _a, _b, _c;
            return ((_b = (_a = this.props).reservationsKeyExtractor) === null || _b === void 0 ? void 0 : _b.call(_a, item, index)) || `${(_c = item === null || item === void 0 ? void 0 : item.reservation) === null || _c === void 0 ? void 0 : _c.day}${index}`;
        };
    ...
    render() {
        ...
        if (!items || selectedDay && !items[toMarkingFormat(selectedDay)]) {
            ...
            return React.createElement(ActivityIndicator, { style: this.style.indicator, color: theme === null || theme === void 0 ? void 0 : theme.indicatorColor });
        }
