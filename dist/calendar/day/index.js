...
const Day = React.memo((props) => {
    ...
    return (
    //@ts-expect-error
    React.createElement(Component, Object.assign({}, props, { accessibilityLabel: getAccessibilityLabel }, dayComponentProps), formatNumbers(_date === null || _date === void 0 ? void 0 : _date.getDate())));
}, areEqual);
export default Day;
Day.displayName = 'Day';
